...
# TODO: These three imports won't be needed since the cmdline_parser will handle them
...
# TODO: This function should take a CmdlineParser object as a parameter
def play_full_game():
    # TODO: Instead of asking the user for the board type here...
    # 1. call the helper function in the CmdlineParser class to get a board
    # 2. Also, find a relevant method to get the winning_score threshold
...
if __name__ == "__main__":
    # TODO: Create an "environment" which is really just a new CmdlineParser
    # Also, let's not always play a game. Let's check if the user passed the --rules cmdline flag
    # If so, DON'T play a game, just print rules and exit.
    print_instructions()
    play_full_game()
