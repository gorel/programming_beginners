...
class BasicBoggleBoard(object):
    # TODO: Add `env` as an input argument to __init__
    # 1. Also, set `self.env` within the method body
...
class WeightedBoggleBoard(BasicBoggleBoard):
    ...
    # TODO: Add `env` as an input argument to __init__
    # 1. Also, update the call to super() below
    def __init__(self, words_filename, min_word_len, board_size):
        super().__init__(words_filename, min_word_len, board_size)
