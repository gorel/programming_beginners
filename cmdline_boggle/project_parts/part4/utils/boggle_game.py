...
# TODO: Import the scoring module here
...
class BasicBoggleBoard(object):
    ...
    # TODO: This function should also take a high_scores object now
    def score_words(self, words):
        ...
        for word in words:
            if self.dictionary.word_exists(word):
                ...
                # TODO: Check for new best word score
                # Look in the methods defined in scoring to maybe insert a new top word score
